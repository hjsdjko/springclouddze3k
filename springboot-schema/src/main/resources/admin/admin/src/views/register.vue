  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">房产销售平台注册</h1>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.nianling) && `zhongjie` == this.tableName){
        this.$message.error(`年龄不能为空`);
        return
      }
      if((!this.ruleForm.lianxidianhua) && `zhongjie` == this.tableName){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210404/119b883576804bcea561e63f661d09ec.jpg");
		height: 100vh;
