<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yuyuekanfang','在线签约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="zaixianqianyueCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'在线签约':'' }}</el-button>
                <el-button v-if="isAuth('yuyuekanfang','在线签约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="zaixianqianyueCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'在线签约':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuyuekanfang','在线签约') && contents.tableBtnIcon == 0" type="success" size="mini" @click="zaixianqianyueCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'在线签约':'' }}</el-button>
    ...
    <zaixianqianyue-cross-add-or-update v-if="zaixianqianyueCrossAddOrUpdateFlag" :parent="this" ref="zaixianqianyueCrossaddOrUpdate"></zaixianqianyue-cross-add-or-update>
...
import zaixianqianyueCrossAddOrUpdate from "../zaixianqianyue/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      zaixianqianyueCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    zaixianqianyueCrossAddOrUpdate,
  },
  methods: {
    contentStyleChange() {
    ...
    zaixianqianyueCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.zaixianqianyueCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yuyuekanfang');
      this.$nextTick(() => {
      this.$refs.zaixianqianyueCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
    },
