<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="房源编号" prop="fangyuanbianhao">
            <el-input v-model="ruleForm.fangyuanbianhao" 
                placeholder="房源编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fangyuanbianhao" label="房源编号" prop="fangyuanbianhao">
              <el-input v-model="ruleForm.fangyuanbianhao" 
                placeholder="房源编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="房屋户型" prop="fangwuhuxing">
          <el-select v-model="ruleForm.fangwuhuxing" placeholder="请选择房屋户型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="价钱" prop="jiaqian">
          <el-input v-model="ruleForm.jiaqian" 
              placeholder="价钱" clearable  :readonly="ro.jiaqian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="价钱" prop="jiaqian">
              <el-input v-model="ruleForm.jiaqian" 
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mianji = true;
          ...
          if(o=='jiaqian'){
            this.ruleForm.jiaqian = obj[o];
	    this.ro.jiaqian = true;
            continue;
          }
	...
	this.ruleForm.fangwuxiangqing = this.ruleForm.fangwuxiangqing.replace(reg,'../../../springclouddze3k/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
