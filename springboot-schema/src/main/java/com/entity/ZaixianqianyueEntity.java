...
public class ZaixianqianyueEntity<T> implements Serializable {
	 ...
	 * 设置：签约编号
	 */
	public void setQianyuebianhao(String qianyuebianhao) {
		this.qianyuebianhao = qianyuebianhao;
	}
	/**
	 * 获取：签约编号
	 */
	public String getQianyuebianhao() {
		return qianyuebianhao;
	}
	/**
	 * 设置：房源编号
	 */
