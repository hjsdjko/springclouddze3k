...
public class ZaixianqianyueController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZaixianqianyueEntity zaixianqianyue, 
		...
		if(tableName.equals("zhongjie")) {
			zaixianqianyue.setZhongjiezhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			zaixianqianyue.setZhanghao((String)request.getSession().getAttribute("username"));
		}
